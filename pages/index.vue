...
<ol type="arabic">
    <li>
        ...
        <p>list item.</p>
        <ol>
            <li><label>1.1</label><p>list item.</p></li>
            <li><label>1.2</label><p>list item.</p></li>
        </ol>
    </li>
    <li><label>2.</label><p>list item.</p></li>
    <li><label>3.</label><p>list item.</p></li>
    <li><label>4.</label><p>list item.</p></li>
</ol>
<exception>
